...
#Julia_EXECUTABLE=/PATH/TO/BIN/JULIA

# Build!
#run(`cmake -DADOLC_DIR=$(ADOLC_DIR) -DJlCxx_DIR=$(JlCxx_DIR) Julia_PREFIX=$(Julia_PREFIX) -DJulia_EXECUTABLE=$(Julia_EXECUTABLE) -S$(src_DIR) -B$(build_DIR)`)
